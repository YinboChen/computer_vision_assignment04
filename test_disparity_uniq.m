function disparity_map = test_disparity_uniq(left_img, right_img, max_disparity, window_size, uniqueness_factor)
     left_img = rgb2gray(imread('frame_1L.png'));
     right_img = rgb2gray(imread('frame_1R.png'));
     max_disparity = 64;
     window_size = 5;
     uniqueness_factor = 1.5;
